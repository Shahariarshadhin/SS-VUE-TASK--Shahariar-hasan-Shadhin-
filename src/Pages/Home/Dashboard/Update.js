...
const Update = () => {
    ...
    const updateUser = async (id, upStaff) => {
        ...
        setAdmin(
            admin.map((admin) => (admin.id === id ? { ...admin, ...data } : admin))
        )
    }
            ...
            <div class="card w-96 bg-base-100 shadow-xl mx-auto">
                ...
                <div class="card-body">
                    <form className='' onSubmit={e => (onSubmit(e))}>
                        ...
                        <input class="input input-bordered input-accent w-full max-w-xs mb-2 bg-info" value="Update" type="submit" />
